        ...
        return (
            <div className="about-container">
                ...
                <Row>
                    ...
                    <Col sm={{span:10,offset:1}} md={{span:8, order:2}}>
                        <img src={group} className="group-photo" />
                    </Col>
                    <Col md={{span:8,order:1}}>
                    <h1 className="about-title">Contributors</h1>
                        <Row>
                            <Col xs={{span:10,offset:1}} sm={5}>
                                <h3>Mentors</h3>
...
TeamMemberListing.propTypes = { teamID: PropTypes.string };
...
TeamMember.propTypes =  {  data: PropTypes.object.isRequired };
