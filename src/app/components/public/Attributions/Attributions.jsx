                ...
                <Row>
                    <Col md={8} mdPush={2}>
                        ...
                        <table className="table table-responsive">
                            ...
                            <tr>
                                <td className="source">A Wiki of Ice and Fire</td>
                            ...
                            <tr>
                                <td className="source">Game of Thrones wiki</td>
                            ...
                            <tr>
                                <td className="source">404 image</td>
                                <td></td>
                            ...
                            <tr>
                                <td className="source">MediaWiki</td>
                                <td></td>
                            ...
                            <tr>
                                <td className="source">Wikipedia</td>
                            ...
                            <tr>
                                <td className="source">Twitter</td>
